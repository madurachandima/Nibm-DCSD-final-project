...
?>
            ...
            <div class="container">
                ...
                <div id="navbar" class="navbar-collapse collapse">
                    <ul class="nav navbar-nav navbar-right">
                        <li class="active"><a href="tuter_home.php">Home</a></li>
                        <li><a href="tuter_about.php">About</a></li>
    ...
    <form action="" method="POST" enctype="multipart/form-data">
            <label class="uploadtext" >Uploading Files</label>
            <p><input class="btn btn-success"  type="file" name="file"/></p>
            <p><input type="submit" name="upload"  class="btn btn-primary" value="Upload"></p>
