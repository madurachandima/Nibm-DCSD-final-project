...
$query = "SELECT * FROM newfiles ORDER BY id DESC";
...
<body>
        ...
        <div class="container">
            ...
            <div id="navbar" class="navbar-collapse collapse">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li class="active"><a href="admin_file_delete.php">Delete File</a></li>
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a href="feedback_data.php">Feed Back Data</a></li>
    ...
    <div class="container">
        ...
        <div class="table-responsive">
            <h3 align="center">Delete PDF</h3><br />
